...
|------|------|------|------------|------|--------|--------|
| 全国大学生数学建模竞赛 (CUMCM) | 2025 | `templates/cumcm/` | `cumcm` | 中文 | `ctexart` | 承诺书 + AI Declaration |
...
> **电子版提交**：承诺书、AI Declaration 等页面可在 `main_*.tex` 中注释对应 `\input`，详见各模板注释。
...
- **`templates/<赛事>/`**：仅保留该赛差异（承诺书、Summary Sheet、AI Declaration、章节骨架）。
