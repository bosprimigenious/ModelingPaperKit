...
| `python scripts/preflight.py --target cumcm --show-info` | 打印 preflight 的全部信息项，用于模板占位符和构建日志追踪 |
...
| `python scripts/check_submission.py --target cumcm` | 检查国赛电子版默认模式、无目录、纸质前置页隔离、构建产物和支撑材料基础风险 |
